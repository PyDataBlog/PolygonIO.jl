...
Get stock trades for a given ticker symbol on a specified date.
     ...
     * See https://polygon.io/docs/get_v2_ticks_stocks_trades__ticker___date__anchor for documentation response attributes.
"""
...
Get NBBO quotes for a given ticker symbol on a specified date.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_ticks_stocks_nbbo__ticker___date__anchor for documentation response attributes.
...
Get the most recent trade for a given stock.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_last_trade__stocksTicker__anchor for documentation response attributes.
"""
...
Get the most recent NBBO (Quote) tick for a given stock.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_last_nbbo__stocksTicker__anchor for documentation response attributes.
"""
...
Get the open, close and afterhours prices of a stock symbol on a certain date.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v1_open-close__stocksTicker___date__anchor for documentation response attributes.
"""
...
Get the daily open, high, low, and close (OHLC) for the entire stocks/equities markets.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_aggs_grouped_locale_us_market_stocks__date__anchor for documentation response attributes.
...
Get the previous day's open, high, low, and close (OHLC) for the specified stock ticker.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_aggs_ticker__stocksTicker__prev_anchor for documentation response attributes.
"""
...
For example, if timespan = ‘minute’ and multiplier = ‘5’ then 5-minute bars will be returned.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_aggs_ticker__stocksTicker__range__multiplier___timespan___from___to__anchor for documentation response attributes.
"""
...
Note: Snapshot data is cleared at 12am EST and gets populated as data is received from the exchanges. This can happen as early as 4am EST.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_snapshot_locale_us_markets_stocks_tickers_anchor for documentation response attributes.
"""
...
Note: Snapshot data is cleared at 12am EST and gets populated as data is received from the exchanges. This can happen as early as 4am EST.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_snapshot_locale_us_markets_stocks_tickers__stocksTicker__anchor for documentation response attributes.
...
Note: Snapshot data is cleared at 12am EST and gets populated as data is received from the exchanges.
    ...
    # Returns
     * A JSON3.Array or specified tabular representation of the JSON3.Array
     * See https://polygon.io/docs/get_v2_snapshot_locale_us_markets_stocks__direction__anchor for documentation response attributes.
"""
